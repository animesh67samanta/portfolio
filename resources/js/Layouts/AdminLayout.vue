    ...
    <div class="min-h-screen bg-gray-50 transition-colors duration-300 dark:bg-gray-900">
        ...
        >
            ...
            <div class="flex h-16 items-center justify-between px-4 border-b border-gray-200    dark:border-gray-800">
                ...
                <button
                    type="button"
                    class="lg:hidden absolute right-4 flex items-center justify-center h-9 w-9 rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800"
                    @click="isSidebarOpen = false"
                >
                ...
                >
                    <div class="flex items-center gap-3">
                        <component 
                            ...
                            :class="isActiveRoute(item.routeName) ? 'text-indigo-400 dark:text-indigo-400' : 'text-gray-400 group-hover:text-gray-600 dark:text-gray-500 dark:group-hover:text-gray-300'"
                        />
        ...
        <div class="lg:pl-80">
            ...
            <header class="sticky top-0 z-20 border-b border-gray-200 bg-white/80 backdrop-blur-lg dark:border-gray-800 dark:bg-gray-900/80">
                <div class="flex h-16 items-center justify-between px-4 sm:px-6">
                    ...
                    <!-- Mobile Center Icon -->
                    <div class="flex justify-center items-center py-10 lg:hidden">
                        <ApplicationIcon class="h-12 w-auto object-contain" />
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <div class="relative flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white">
                                    {{ userName.charAt(0).toUpperCase() }}
                                    <div class="absolute -bottom-1 -right-1 h-3 w-3 rounded-full border-2 border-white bg-green-500 shadow-md dark:border-gray-900"></div>
                                </div>
